...
def command_data_add():
  ...
  _command_add('Device','storage',{'-t':"print(device.Storage().total(command_data['Device']['storage']['run']))",'-u':"print(device.Storage().used(command_data['Device']['storage']['run']))",'-f':"print(device.Storage().free(command_data['Device']['storage']['run']))",'-p':"print(device.Storage().percent(command_data['Device']['storage']['run']))"},['storage -t {dir}','storage -u {dir}','storage -f {dir}','storage -p {dir}'],['Used to get the total amount of storage','Used to get the storage occupied','Used to get the remaining amount of storage','Used to get the percentage of storage occupied'])
  _command_add('Device','memory',{'-t':"print(device.Memory().total())",'-u':"print(device.Memory().used())",'-f':"print(device.Memory().free())",'-p':"print(device.Memory().percent())"},['memory -t','memory -u','memory -f','memory -p'],['Used to get the total amount of memory','Used to get the memory occupied','Used to get the remaining amount of memory','Used to get the percentage of memory occupied'])
